...
public class CustomerDAOImpl implements CustomerDAO {
    ...
    private static transient File file = new File("D:\\JAVA\\Leapfrog Academy\\Projects\\Day_09\\Day_09_WebApp1OnlyJSP\\temp.dat");
    ...
    public boolean writeCustomerObjectToFile(List<Customer> customers) {
        try {
            ...
            System.out.println("Object Write Successful!");
            ops.flush();
            return true;
        } catch (IOException e) {
